...
public interface ParameterizedTypeVisitor<R, E extends Throwable>
    extends TypeVisitor<R, E> {
  ...
  public static abstract class ParameterizedTypeThrowsVisitor<
      R, E extends Throwable> extends TypeVisitor.TypeThrowsVisitor<R, E>
      implements ParameterizedTypeVisitor<R, E> {
