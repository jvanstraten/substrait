...
public interface TypeExpression {
  ...
  public static TypeExpressionCreator withNullability(boolean nullable) {
    return nullable ? TypeExpressionCreator.NULLABLE
                    : TypeExpressionCreator.REQUIRED;
  }
  ...
  static abstract class BaseTypeExpression implements TypeExpression {
    ...
    abstract <R, E extends Throwable>
        R acceptE(final TypeExpressionVisitor<R, E> parameterizedTypeVisitor)
            throws E;
  }

  @Value.Immutable
  static abstract class FixedChar
      extends BaseTypeExpression implements NullableType {
    ...
    <R, E extends Throwable>
        R acceptE(final TypeExpressionVisitor<R, E> visitor) throws E {
  ...
  @Value.Immutable
  static abstract class BinaryOperation extends BaseTypeExpression {
    public enum OpType {
      ADD,
      SUBTRACT,
      MULTIPLY,
  ...
  @Value.Immutable
  static abstract class NotOperation extends BaseTypeExpression {
  ...
  @Value.Immutable
  static abstract class IfOperation extends BaseTypeExpression {
  ...
  @Value.Immutable
  static abstract class IntegerLiteral extends BaseTypeExpression {
  ...
  @Value.Immutable
  static abstract class ReturnProgram extends BaseTypeExpression {
