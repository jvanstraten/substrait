...
public class TypeExpressionCreator extends TypeCreator
  ...
  public static final TypeExpressionCreator REQUIRED =
      new TypeExpressionCreator(false);
  public static final TypeExpressionCreator NULLABLE =
      new TypeExpressionCreator(true);

  protected TypeExpressionCreator(boolean nullable) { super(nullable); }

  public TypeExpression fixedCharE(TypeExpression len) {
    return TypeExpression.FixedChar.builder()
        .nullable(nullable)
        .length(len)
        .build();
  }
  ...
  public TypeExpression varCharE(TypeExpression len) {
    return TypeExpression.VarChar.builder()
        .nullable(nullable)
        .length(len)
        .build();
  }
  ...
  public TypeExpression fixedBinaryE(TypeExpression len) {
    return TypeExpression.FixedBinary.builder()
        .nullable(nullable)
        .length(len)
        .build();
  }

  public TypeExpression decimalE(TypeExpression precision,
                                 TypeExpression scale) {
  ...
  public TypeExpression structE(TypeExpression... types) {
    return TypeExpression.Struct.builder()
        .nullable(nullable)
        .addFields(types)
        .build();
  }
  ...
  public TypeExpression listE(TypeExpression type) {
    return TypeExpression.ListType.builder()
        .nullable(nullable)
        .elementType(type)
        .build();
  }
  ...
  public TypeExpression mapE(TypeExpression key, TypeExpression value) {
    return TypeExpression.Map.builder()
        .nullable(nullable)
        .key(key)
        .value(value)
        .build();
  ...
  public static TypeExpression program(TypeExpression finalExpr,
                                       Assign... assignments) {
  ...
  public static TypeExpression minus(TypeExpression left,
                                     TypeExpression right) {
    return binary(TypeExpression.BinaryOperation.OpType.SUBTRACT, left, right);
  }

  public static TypeExpression binary(TypeExpression.BinaryOperation.OpType op,
                                      TypeExpression left,
                                      TypeExpression right) {
