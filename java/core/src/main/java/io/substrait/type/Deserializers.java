...
public class Deserializers {
  static final org.slf4j.Logger logger =
      org.slf4j.LoggerFactory.getLogger(Deserializers.class);

  public static final StdDeserializer<ParameterizedType> PARAMETERIZED_TYPE =
      new ParseDeserializer<>(ParameterizedType.class,
                              ParseToPojo::parameterizedType);
  ...
  public static final StdDeserializer<TypeExpression> DERIVATION_EXPRESSION =
      new ParseDeserializer<>(TypeExpression.class,
                              ParseToPojo::typeExpression);
  ...
  public static class ParseDeserializer<T> extends StdDeserializer<T> {
    ...
    public ParseDeserializer(
        Class<T> clazz,
        Function<SubstraitTypeParser.StartContext, T> converter) {
      super(clazz);
