...
class CalciteTypeTest extends CalciteObjs {
  static final org.slf4j.Logger logger =
      org.slf4j.LoggerFactory.getLogger(CalciteTypeTest.class);

  @ParameterizedTest
  @ValueSource(booleans = {true, false})
  void bool(boolean nullable) {
    testType(Type.withNullability(nullable).BOOLEAN, SqlTypeName.BOOLEAN,
             nullable);
  }
  ...
  void i16(boolean nullable) {
    testType(Type.withNullability(nullable).I16, SqlTypeName.SMALLINT,
             nullable);
  }
  ...
  void time(boolean nullable) {
    testType(Type.withNullability(nullable).TIME, SqlTypeName.TIME, nullable,
             6);
  }
  ...
  void timestamp(boolean nullable) {
    testType(Type.withNullability(nullable).TIMESTAMP, SqlTypeName.TIMESTAMP,
             nullable, 6);
  }
  ...
  void timestamptz(boolean nullable) {
    testType(Type.withNullability(nullable).TIMESTAMP_TZ,
             SqlTypeName.TIMESTAMP_WITH_LOCAL_TIME_ZONE, nullable, 6);
  }

  @ParameterizedTest
  @ValueSource(booleans = {true, false})
  void intervalYear(boolean nullable) {
    testType(Type.withNullability(nullable).INTERVAL_YEAR,
             type.createSqlIntervalType(TypeConverter.INTERVAL_YEAR), nullable);
  }

  @ParameterizedTest
  @ValueSource(booleans = {true, false})
  void intervalDay(boolean nullable) {
    testType(Type.withNullability(nullable).INTERVAL_DAY,
             type.createSqlIntervalType(TypeConverter.INTERVAL_DAY), nullable);
  }

  @ParameterizedTest
  @ValueSource(booleans = {true, false})
  void string(boolean nullable) {
    testType(Type.withNullability(nullable).STRING, SqlTypeName.VARCHAR,
             nullable);
  }
  ...
  void binary(boolean nullable) {
    testType(Type.withNullability(nullable).BINARY, SqlTypeName.VARBINARY,
             nullable);
  }
  ...
  void fixedBinary(boolean nullable) {
    testType(Type.withNullability(nullable).fixedBinary(74), SqlTypeName.BINARY,
             nullable, 74);
  }
  ...
  void fixedChar(boolean nullable) {
    testType(Type.withNullability(nullable).fixedChar(74), SqlTypeName.CHAR,
             nullable, 74);
  }
  ...
  void varchar(boolean nullable) {
    testType(Type.withNullability(nullable).varChar(74), SqlTypeName.VARCHAR,
             nullable, 74);
  }
  ...
  void decimal(boolean nullable) {
    testType(Type.withNullability(nullable).decimal(38, 13),
             SqlTypeName.DECIMAL, nullable, 38, 13);
  }

  @ParameterizedTest
  @ValueSource(booleans = {true, false})
  void list(boolean nullable) {
    testType(Type.withNullability(nullable).list(Type.REQUIRED.I16),
  ...
  void map(boolean nullable) {
    testType(Type.withNullability(nullable).map(Type.REQUIRED.STRING,
                                                Type.REQUIRED.I8),
             type.createMapType(type.createSqlType(SqlTypeName.VARCHAR),
  ...
  void nestedStruct() {
    testType(Type.REQUIRED.struct(
             ...
             Arrays.asList("topStruct1", "inner1", "inner2", "topStruct2",
                           "inner3", "inner4", "topVarChar"));
  }

  private void testType(TypeExpression expression, SqlTypeName typeName,
                        boolean nullable) {
    testType(expression, type.createTypeWithNullability(
                             type.createSqlType(typeName), nullable));
  }
  ...
  private void testType(TypeExpression expression, SqlTypeName typeName,
                        boolean nullable, int prec) {
    testType(expression, type.createTypeWithNullability(
                             type.createSqlType(typeName, prec), nullable));
  }

  private void testType(TypeExpression expression, SqlTypeName typeName,
                        boolean nullable, int prec, int scale) {
    testType(expression,
  ...
  private void testType(TypeExpression expression, RelDataType calciteType,
    ...
    assertEquals(calciteType,
                 TypeConverter.convert(type, expression, dfsFieldNames));
  }
