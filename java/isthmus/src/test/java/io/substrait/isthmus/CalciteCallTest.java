...
public class CalciteCallTest extends CalciteObjs {
  static final org.slf4j.Logger logger =
      org.slf4j.LoggerFactory.getLogger(CalciteCallTest.class);
  ...
  public void coerceNumericOp() {
    test(
        ...
        func -> {
          ...
          assertEquals(ExpressionCreator.cast(Type.REQUIRED.I64,
  ...
  public void directMatchAnd() {
    test("and:bool", rex.makeCall(AND, c(true, SqlTypeName.BOOLEAN),
                                  c(true, SqlTypeName.BOOLEAN)));
  }

  @Test
  public void directMatchOr() {
    test("or:bool", rex.makeCall(OR, c(false, SqlTypeName.BOOLEAN),
                                 c(true, SqlTypeName.BOOLEAN)));
  }
