...
public class PlanEntryPoint implements Callable<Integer> {
  ...
  @Option(
      names = {"-c", "--create"},
      description =
          "Create table statements e.g. CREATE TABLE T1(foo int, bar bigint)")
