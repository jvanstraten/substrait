...
public class FunctionMappings {
  // Static list of signature mapping between Calcite SQL operators and
  // Substrait base function names.
  ...
  static {
    ...
    AGGREGATE_SIGS = ImmutableList.<Sig>builder()
                         .add(s(SqlStdOperatorTable.SUM, "sum"),
